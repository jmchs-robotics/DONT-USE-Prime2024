...
import static frc.robot.Constants.Module0;
import static frc.robot.Constants.Module1;
...
public class SwerveDriveSubsystem extends SubsystemBase {
    ...
    private double mSpeedMultipler = 1;
    ...
    public SwerveDriveSubsystem() {
        ...
        mSwerveModules = new SwerveDriveModule[] {
            new SwerveDriveModule(0, Module0.constants), // Front Left
            new SwerveDriveModule(1, Module1.constants), // Front Right
            new SwerveDriveModule(2, Module2.constants), // Back Left
            new SwerveDriveModule(3, Module3.constants) // Back Right
        };
    ...
    public void holonomicDrive(double forward, double strafe, double rotation, boolean fieldOriented) {
        forward *= getSpeedMutliplier();
        strafe *= getSpeedMutliplier();
    ...
    public void holonomicDriveToZero() {
      holonomicDrive(0,0,0, isFieldOriented());
    }
    ...
    public void setAdjustmentAngle(double angle) {
        mAdjustMentAngle = angle;
    }

    public double getSpeedMutliplier() {
        return mSpeedMultipler;
    }

    public void setSpeedMultiplier(double speed) {
        mSpeedMultipler = speed;
    }
}